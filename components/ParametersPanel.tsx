  ...
  return (
    <div className="p-6 h-full flex flex-col items-start pt-8 text-gray-300">
      ...
      <div className="w-full max-w-md mb-4">
        <div className="llm-row items-center">
          ...
          <input
            ...
            className="h-5 w-5 bg-gray-700 text-cyan-500 border-gray-500 rounded focus:ring-cyan-600 cursor-pointer"
      ...
      <div className="mt-6 w-full max-w-md flex justify-start gap-3">
        ...
        <button
          onClick={handleClose}
          className="llm-button bg-gray-600 border-gray-500 text-gray-300 hover:bg-gray-500 active:bg-gray-700"
